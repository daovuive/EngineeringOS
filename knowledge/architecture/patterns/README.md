...
Reusable architecture/design-pattern knowledge: context, problem, forces, solution, trade-offs, and sources. Lessons with IDs and progress remain in architect/lessions/.

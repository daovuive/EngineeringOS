# knowledge/personal/architecture-notes

[Parent directory](../README.md) · [Structure Governance](../../../docs/STRUCTURE_GOVERNANCE.md)

## Purpose and Scope

Personal architecture-thinking notes not tied to a specific lesson. When content belongs to a lesson or project, store it there and link to it instead of copying it.

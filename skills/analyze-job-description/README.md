# skills/analyze-job-description

[Parent directory](../README.md) · [Structure Governance](../../docs/STRUCTURE_GOVERNANCE.md)

## Purpose and Scope

Job-description analysis package. SKILL.md is the primary workflow; this README only describes the package location. Use job descriptions and evidence profiles from career/. Do not store CV or job-description copies in the package.

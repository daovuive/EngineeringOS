# knowledge/standards/AUTOSAR

[Parent directory](../README.md) · [Structure Governance](../../../docs/STRUCTURE_GOVERNANCE.md)

## Purpose and Scope

AUTOSAR concepts, documents, and notes. State the relevant platform/release; do not combine sources from multiple releases into one general requirement.

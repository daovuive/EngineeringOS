...
Shared software-engineering knowledge: code design, testing, builds, and development practices. Code that runs EngineeringOS belongs in engineering_os/; standards documentation belongs in standards/.

# Bối cảnh và bài thực hành kiến trúc ban đầu

[Mục lục](README.md)

Bản lưu nội dung bài thực hành từ README gốc trước đợt tổ chức 2026-09-05.
Đây là bối cảnh lịch sử và yêu cầu dự kiến, không phải trạng thái triển khai
hoặc quy tắc cấu trúc mới. Migration README gốc đã được duyệt và áp dụng ngày 2026-09-05.
Các trích dẫn cuộc chat cũ chưa có nguồn đã được đánh dấu thay vì giả lập link.
...
iSAQB nhấn mạnh rằng quality requirements có ảnh hưởng mạnh tới architecture và cần được đưa vào architecture/design decisions. [Trích dẫn từ cuộc chat cũ chưa truy xuất được; cần đối chiếu nguồn trước khi dùng.]
...
iSAQB cũng nhấn mạnh documentation cần hỗ trợ giao tiếp lâu dài về decisions, structures và concepts; đồng thời tránh redundancy và hỗ trợ version/configuration management. [Trích dẫn từ cuộc chat cũ chưa truy xuất được; cần đối chiếu nguồn trước khi dùng.]
...
Theo tài liệu Software Architecture with C++, functional requirement trở thành architecturally significant khi những đặc tính của nó có thể ảnh hưởng đến kiến trúc; quality attributes và constraints cũng là những yếu tố quan trọng cần xem xét. [Trích dẫn từ cuộc chat cũ chưa truy xuất được; cần đối chiếu nguồn trước khi dùng.]
